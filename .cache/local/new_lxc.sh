...
# source hash: 3edc24ebc2a984d818f0d504ee74edf0
...
mdsh_raw_todo+=($'while read uid gid file; do echo "$((uid-558752)):$((gid-558752)) $file"; done < <(find /srv/lxc/lxc0007/rootfs/ \\( -uid 558752 -o -gid 558752 \\) -printf \'%U %G "%p"\\n\') | less\n')
